!function($){
	...
	$("#card-selector").validate({
		rules : {
			TempCardNumber : {
				required : true,
				"regex-pattern" : true
			},
			TempCardSecurityCode : {
				required : true,
				"regex-pattern" : true
			}
		},
		messages : {
			TempCardNumber : "Please enter a valid 15 digit card number",
			TempCardSecurityCode : "Please enter a valid 4-digit security code"
		},
...
$("#TempCardNumber").numeric();
$("#TempCardSecurityCode").numeric();
