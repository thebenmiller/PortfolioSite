(function($){
      ...
      var toggleTabs = {
        ...
        pushState: function(e) {
          ...
          if(section === '0'){
            History.replaceState({screenSize: breakpoint, section: 0}, '', '/Account/AccountSettings/test.html?Account')
          }else if(section === '1'){
            History.replaceState({screenSize: breakpoint, section: 1}, '', '/Account/AccountSettings/test.html?Profile')
          }else if (section === '2'){
            History.replaceState({screenSize: breakpoint, section: 2}, '', '/Account/AccountSettings/test.html?Notifications')
          }
        },
